...
bool RenderContext_D3D11::InitializeRHI()
{
	...
	// Create Mesh
	{
		...
		{
			{ LVVec3(-1.0f, -1.0f, 0.50f), LVVec2(0.0f, 1.0f) },			// bottom left
			{ LVVec3(-1.0f, 1.0f, 0.50f), LVVec2(0.0f, 0.0f) },			// top left
			{ LVVec3(1.0f, 1.0f, 0.50f), LVVec2(1.0f, 0.0f) },			// top right
			{ LVVec3(1.0f, -1.0f, 0.50f), LVVec2(1.0f, 1.0f) },			// bottom right
		};
...
bool RenderContext_D3D11::InitializeVideo()
{
	...
	//Player.load("E:/dev/VRClient/UnrealClient/XYVR410/Content/Movies/wing.mp4");
	//Player.load("F:\\files\\hlh\\showcase.mp4");
	Player.load("F:\\User\\VRMp4\\[极限运动]LG 4K demo Skyliner 4K 3D x264.mkv");
	//Player.load("F:\\User\\VRMp4\\LG 4k0529.mp4");
