...
#define VERTEX_COORDINATE3D		(1<<8)
#define INSTANCE_TRANSFORM3D	(1<<16)
#define INSTANCE_TRANSFORM2D	(1<<17)
#define INSTANCE_TEXTILE		(1<<18)
...
#define SEMANTICS_TRANSFORM				"TRANSFORM"
#define SEMANTICS_RECTOFFSET			"RECTOFFSET"
#define SEMANTICS_RECTSIZE				"RECTSIZE"
#define SEMANTICS_RECTSCALE				"RECTSCALE"
#define SEMANTICS_TILEOFFSET			"TILEOFFSET"
#define SEMANTICS_TILESCALE				"TILESCALE"
