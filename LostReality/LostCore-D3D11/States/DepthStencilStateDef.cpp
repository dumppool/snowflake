...
void D3D11::FDepthStencilStateMap::InitializeState(uint32 flags)
{
	...
	desc.DepthEnable = (HAS_FLAGS(DS_DEPTH_READ, flags)|HAS_FLAGS(DS_DEPTH_WRITE, flags)) ? TRUE : FALSE;
	...
	desc.StencilEnable = (HAS_FLAGS(DS_STENCIL_READ, flags) | HAS_FLAGS(DS_STENCIL_WRITE, flags)) ? TRUE : FALSE;
